			...
			<div className="main-container">
				{!showResults ? (
					<>
						<div className="greet">
							<p>
								<span>Hello , I am Swarnendu's AI friend</span>
							</p>
							<center>
				...
				<div className="main-bottom">
					...
					<div className="bottom-info">
						<p>
							THE GOD may display inaccurate info, including about people, so
							double-check its responses. Your privacy & SR Apps
						</p>
					</div>
				</div>
			</div>
